...
//Adaptee class (incompatible with DataReader)
class TxtReader {
 public void readTxt() {
...
//Another concrete class that implements the Target interface
...
//Adapter class that adapts TxtReader to DataReader
class JSONtoAnyDataAdapter implements DataReader {
...
public class AdapterPatternExample {
 public static void main(String[] args) {
     ...
     System.out.println("=== TXT Reader via Adapter ===");
     TxtReader txtReader = new TxtReader();
     DataReader adapter = new JSONtoAnyDataAdapter(txtReader);
     adapter.readData();
 }
}*/
