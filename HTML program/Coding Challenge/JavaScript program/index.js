...
// and also display a timer at the top (in header section) and create one button as a calculator(+ , - ,*) 
// based on user choice input call the arrow function and input you can take the input of two number  using text box
