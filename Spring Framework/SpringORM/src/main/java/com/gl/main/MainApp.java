...
//import com.gl.dao.StudentDaoImpl;
...
//        List<Student> studentsAfterDeletion = studentDaolml.findAll();
...
public class MainApp {
    public static void main(String[] args) {
        ...
        Student student1 = new Student();
         // Manually set ID for demonstration
        student1.setName("Janhavi");
        student1.setEmail("janhavi03@gmail.com");
...
//        System.out.println("Retrieved Student: " + retrievedStudent);
        ...
        Student student2 = new Student();
         // Manually set ID for demonstration
        student2.setName("Sumithra");
        student2.setEmail("sumithramarakala@gmail.com");
        studentDao.save(student2);

        Student student3 = new Student();
        // Manually set ID for demonstration
        student3.setName("Sonika");
