...
//without synchronization ( it will not lock and it is unsafe (not thread safe)
// and also may lead to the race condition which could cause the false 
//readability or wrong balance
