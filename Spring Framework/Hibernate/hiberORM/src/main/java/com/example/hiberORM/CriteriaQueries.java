...
//		
//		//....Read the data using critera builder
//		CriteriaBuilder cb=session.getCriteriaBuilder();//obtain a HibernateCriteriaBuilder
...
//		listOfEmp.stream().filter(e->e.getName().equalsIgnoreCase("Sumithra"))
...
//		listOfEmp.stream().filter(e->e.getId()>5)
//		.forEach(System.out :: println);
//		
//		
//		System.out.println("**** Sorted List *****");
//		listOfEmp.stream().sorted(Comparator.comparing(Employee::getName)).forEach(System.out :: println);
//		
//		System.out.println("**** Sorted List in Ascending Order *****");
//		listOfEmp.stream().sorted(Comparator.comparing(Employee::getId))
//		.forEach(System.out :: println);
//		
...
//		.forEach(System.out :: println);
//		
//		System.out.println("****  email in Lower case *****");
...
//
//import com.example.hiberORM.model.Employee;
//import com.example.HibernateORM.util.HibernateUtil;
//
//import jakarta.persistence.criteria.CriteriaBuilder;
