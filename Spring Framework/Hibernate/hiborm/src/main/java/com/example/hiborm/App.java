...
//        
//        Employee emp=new Employee(   "Sumi","sumithra@gmail.com"); //transient)
//        session.persist(emp); //Make a transient instant persistent
//        tx.commit();
//        //Read the data
...
//        q1.setParameter("e","sunil.tholar@outlook.com");
...
//        
//       // System.out.println("The size is : "+getFetch)
//        System.out.println("Result is: "+empList);
//        
//        tx=session.beginTransaction();
//        List<Employee> empList1= session.createNativeQuery("Select * from Employee",Employee.class)
//        		.getResultList();
...
public class App 
{
    public static void main( String[] args )
    {
    	// to obtain/get the session from sessionfactory (It can be multiple session based on multiple services or work)
    		  ...
    		  Employee emp = new Employee("Sunil" , "suchithra@gmail.com"); // transient
...
//    		 
    		tx =  session.beginTransaction();
    		eData.setEmail("sunil.kumar@outlook.com");
   		 System.out.println("Retreived the Data : " + eData);
   		tx.commit();
//    		
    		// HQL Query to write to fetch using email // Parameterized query
