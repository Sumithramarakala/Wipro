...
public class MapExample {
	public static void main(String[] args) {
		...
		map.put(121, "Sumithra");
		map.put(232,"Suchithra" );
		...
		newMap.remove(121);
		System.out.println("After deletion: "+newMap);
		
		
		System.out.println(newMap.containsKey(232));
		System.out.println(newMap.containsKey("Sumithra"));
		System.out.println(newMap.replace(232,"Suchithra","Laxmi" ));
